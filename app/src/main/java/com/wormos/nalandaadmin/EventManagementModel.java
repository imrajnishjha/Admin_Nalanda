...
public class EventManagementModel {
    ...
    public EventManagementModel(String date, String description, String imgUrl, String lowercase_title, String location, String weekday, String time,String title) {
        this.date = date;
